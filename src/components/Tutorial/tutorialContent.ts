...
export const tutorialSteps: TutorialStep[] = [
  {
    ...
    content: "This tool is built following Kedro concepts and core principles. If you are new to Kedro, we'll explain the basics in the following steps.",
    buttonText: "Start introduction to Kedro",
    icon: Sparkles,
  },
  {
    id: 2,
    title: "1. Nodes & Functions",
  ...
  {
    id: 4,
    title: "3. Datasets and the Data Catalog",
